...
function markRelationCode() 
{
	...
	for (i = 0; i < list.length; i++)
	{
		...
		s = s.replace(/(\n|\u200B|^)(aggregator|beep|compile|data|deserialize|difference|dup|echo|else|extend|format|function|if|import|include|init|input|insert|intersection|label|limit|order|parse|pop|program|print|project|project inline|relation|rename|run|select|serialize|set|swap|template|union|update|while|write)/g,"$1<span class='keyword'>$2</span>");
